...
function sortChocolateBasedOnCount(chocolates){
  ...
  let sortColour = Object.keys(countMap).sort().sort((a,b)=> countMap[b]-countMap[a])

  let sortedChocolates = []
  sortColour.forEach((currColor)=>{
...
function changeChocolateColorAllOfxCount(chocolates,color, finalColor){
  ...
  let modifiedChocolate = chocolates.map((currChoco) =>currChoco == color ? finalColor : currChoco)
